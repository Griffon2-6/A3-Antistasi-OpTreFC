...
["name", "Covenant"] call _fnc_saveToTemplate; 						//this line determines the faction name -- Example: ["name", "NATO"] - ENTER ONLY ONE OPTION
["spawnMarkerName", "Covenant Invasion Corridor"] call _fnc_saveToTemplate; 			//this line determines the name tag for the "carrier" on the map -- Example: ["spawnMarkerName", "NATO support corridor"] - ENTER ONLY ONE OPTION
...
["firstAidKits", []] call _fnc_saveToTemplate;  // Relies on autodetection. However, item is tested for for help and reviving.
["mediKits", []] call _fnc_saveToTemplate;  // Relies on autodetection. However, item is tested for for help and reviving.

["vehiclesBasic", ["OPTRE_FC_Type26B_Banshee"]] call _fnc_saveToTemplate; 			//this line determines basic vehicles, the lightest kind available. -- Example: ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["OPTRE_FC_Type26B_Banshee"]] call _fnc_saveToTemplate; 		//this line determines light and unarmed vehicles. -- Example: ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
...
["uavsAttack", ["not_supported"]] call _fnc_saveToTemplate; 				//this line determines attack UAVs -- Example: ["uavsAttack", ["B_UAV_02_CAS_F"]] -- Array, can contain multiple assets
["uavsPortable", ["not_supported"]] call _fnc_saveToTemplate; 				//this line determines portable UAVs -- Example: ["uavsPortable", ["B_UAV_01_F"]] -- Array, can contain multiple assets

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:
["vehiclesMilitiaLightArmed", ["OPTRE_FC_Type26B_Banshee"]] call _fnc_saveToTemplate; //this line determines lightly armed militia vehicles -- Example: ["vehiclesMilitiaLightArmed", ["B_G_Offroad_01_armed_F"]] -- Array, can contain multiple assets
...
["staticAA", ["OPTRE_FC_T26_AA","OPTRE_FC_T56_AAG"]] call _fnc_saveToTemplate; 					//this line determines static AAs -- Example: ["staticAA", ["B_static_AA_F"]] -- Array, can contain multiple assets
["staticMortars", ["not_supported"]] call _fnc_saveToTemplate; 				//this line determines static mortars -- Example: ["staticMortars", ["B_Mortar_01_F"]] -- Array, can contain multiple assets
...
_loadoutData setVariable ["antiInfantryGrenades", ["OPTRE_FC_PlasmaGrenade"]]; 		//this line determines anti infantry grenades (frag and such) -- Example: ["HandGrenade", "MiniGrenade"] -- Array, can contain multiple assets
...
_loadoutData setVariable ["maps", []];				//this line determines map
_loadoutData setVariable ["watches", []];		//this line determines watch
_loadoutData setVariable ["compasses", []];	//this line determines compass
_loadoutData setVariable ["radios", ["ItemRadio"]];			//this line determines radio
_loadoutData setVariable ["gpses", []];			//this line determines GPS
_loadoutData setVariable ["NVGs", ["OPTRE_FC_NVG"]];						//this line determines NVGs -- Array, can contain multiple assets
...
_militaryLoadoutData setVariable ["sidearms", ["OPTRE_FC_Plasma_Pistol"]];
///////////////////////////////
//    Police Loadout Data    //
///////////////////////////////
...
_militiaLoadoutData setVariable ["sidearms", ["OPTRE_FC_Plasma_Pistol"]];
//////////////////////////
//    Misc Loadouts     //
//////////////////////////
